  ...
  if (isTouch) {
    overlay.innerHTML = `
      <div class="${p}onboard-content">
        ...
        <p class="${p}onboard-author">by <a href="https://news.ycombinator.com/user?id=modemuser" target="_blank">modemuser</a> · <a href="https://github.com/modemuser/commentree" target="_blank">github</a></p>
